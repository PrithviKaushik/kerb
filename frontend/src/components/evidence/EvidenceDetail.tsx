  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative grid w-full max-w-4xl grid-cols-1 overflow-hidden rounded-xl border border-white/12 bg-kerb-charcoal/95 sm:grid-cols-2"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="flex flex-col gap-6 p-6 sm:p-8">
          ...
          <p className="mt-auto border-t border-white/10 pt-4 text-[11px] leading-relaxed text-white/35">
            KERB supports human review. No sporting penalty is issued
            automatically.
          </p>
        </div>
      </motion.div>
